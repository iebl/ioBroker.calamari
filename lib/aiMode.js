...
const N = {
	shouldCharge:             { en: "AI Recommendation: Should Charge",              de: "KI-Empfehlung: Laden empfohlen",                  ru: "Рекомендация ИИ: зарядить",               pt: "Recomendação IA: Deve carregar",            nl: "AI-aanbeveling: Laden aanbevolen",  fr: "Recommandation IA: charger",          it: "Raccomandazione IA: Caricare",          es: "Recomendación IA: Cargar",              pl: "Rekomendacja AI: Ładowanie zalecane",      uk: "Рекомендація ШІ: Зарядити",              "zh-cn": "AI建议：应充电" },
	reason:                   { en: "AI Recommendation: Reason",                     de: "KI-Empfehlung: Begründung",                       ru: "Рекомендация ИИ: причина",                pt: "Recomendação IA: Motivo",                   nl: "AI-aanbeveling: Reden",             fr: "Recommandation IA: raison",           it: "Raccomandazione IA: Motivo",            es: "Recomendación IA: Motivo",              pl: "Rekomendacja AI: Powód",                   uk: "Рекомендація ШІ: Причина",               "zh-cn": "AI建议：原因" },
	confidence:               { en: "AI Recommendation: Confidence (%)",             de: "KI-Empfehlung: Konfidenz (%)",                    ru: "Рекомендация ИИ: уверенность (%)",        pt: "Recomendação IA: Confiança (%)",            nl: "AI-aanbeveling: Betrouwbaarheid (%)",fr: "Recommandation IA: confiance (%)",    it: "Raccomandazione IA: Fiducia (%)",       es: "Recomendación IA: Confianza (%)",       pl: "Rekomendacja AI: Pewność (%)",             uk: "Рекомендація ШІ: Впевненість (%)",       "zh-cn": "AI建议：置信度 (%)" },
	targetSocAi:              { en: "AI Recommendation: Target SOC (%)",             de: "KI-Empfehlung: Ziel-SoC (%)",                    ru: "Рекомендация ИИ: целевой SoC (%)",        pt: "Recomendação IA: SoC alvo (%)",             nl: "AI-aanbeveling: Doel-SoC (%)",      fr: "Recommandation IA: SoC cible (%)",    it: "Raccomandazione IA: SoC target (%)",    es: "Recomendación IA: SoC objetivo (%)",    pl: "Rekomendacja AI: Docelowy SoC (%)",        uk: "Рекомендація ШІ: Цільовий SoC (%)",      "zh-cn": "AI建议：目标SoC (%)" },
	lastDecision:             { en: "Last AI Decision Time",                         de: "Zeitpunkt der letzten KI-Entscheidung",           ru: "Время последнего решения ИИ",             pt: "Hora da última decisão de IA",              nl: "Tijdstip laatste AI-beslissing",    fr: "Heure de la dernière décision IA",    it: "Ora dell'ultima decisione IA",          es: "Hora de la última decisión IA",         pl: "Czas ostatniej decyzji AI",                uk: "Час останнього рішення ШІ",               "zh-cn": "最后AI决策时间" },
	scChannel:                { en: "Smart Charging Plan",                           de: "Intelligenter Ladeplan",                          ru: "План умной зарядки",                      pt: "Plano de carregamento inteligente",         nl: "Smart Charging Plan",               fr: "Plan de charge intelligente",         it: "Piano di ricarica intelligente",        es: "Plan de carga inteligente",             pl: "Inteligentny plan ładowania",              uk: "Розумний план зарядки",                  "zh-cn": "智能充电计划" },
	targetSoc:                { en: "Battery Charge Target (%)",                     de: "Ziel-Ladestand Akku (%)",                         ru: "Целевой уровень заряда (%)",              pt: "Meta de carga da bateria (%)",              nl: "Batterij laaddoel (%)",             fr: "Objectif de charge batterie (%)",     it: "Obiettivo di carica batteria (%)",      es: "Objetivo de carga de batería (%)",      pl: "Docelowy poziom naładowania (%)",          uk: "Цільовий рівень заряду (%)",              "zh-cn": "电池充电目标 (%)" },
	cheapPhaseEnd:            { en: "Cheap Electricity Phase End",                   de: "Ende der günstigen Stromphase",                   ru: "Конец дешёвой фазы",                      pt: "Fim da fase de eletricidade barata",        nl: "Einde goedkope stroomfase",         fr: "Fin de la phase bon marché",          it: "Fine fase di elettricità economica",    es: "Fin de la fase de electricidad barata", pl: "Koniec taniej fazy prądu",                 uk: "Кінець дешевої фази",                    "zh-cn": "廉价电力阶段结束" },
	solarSufficiencyTime:     { en: "Estimated Solar Sufficiency Time",              de: "Voraussichtliche solare Deckungszeit",            ru: "Расчётное время солнечного покрытия",     pt: "Hora estimada de suficiência solar",        nl: "Geschatte zonne-voldoendetijd",     fr: "Heure estimée de suffisance solaire", it: "Ora stimata di sufficienza solare",     es: "Hora estimada de suficiencia solar",    pl: "Szacowany czas wystarczalności słonecznej",uk: "Розрахунковий час сонячного покриття",   "zh-cn": "预计太阳能充足时间" },
	energyGapKwh:             { en: "Energy Gap to Bridge (kWh)",                   de: "Zu überbrückende Energielücke (kWh)",             ru: "Энергетический разрыв (кВт·ч)",           pt: "Lacuna de energia a cobrir (kWh)",          nl: "Te overbruggen energiekloof (kWh)", fr: "Écart d'énergie à combler (kWh)",     it: "Gap energetico da colmare (kWh)",       es: "Brecha de energía a cubrir (kWh)",      pl: "Luka energetyczna do wypełnienia (kWh)",   uk: "Енергетичний розрив для перекриття (кВт·год)","zh-cn": "需弥补的能量缺口 (kWh)" },
	estimatedPvKwh:           { en: "Estimated PV in Gap Period (kWh)",              de: "Erwartete PV-Erzeugung in der Lücke (kWh)",      ru: "Ожидаемая выработка СЭС в разрыве (кВт·ч)",pt: "PV estimado no período de lacuna (kWh)",  nl: "Geschatte PV in de gapperiode (kWh)",fr: "PV estimé dans la période de gap (kWh)",it: "PV stimato nel periodo di gap (kWh)", es: "PV estimado en el período de brecha (kWh)",pl: "Szacowana PV w okresie luki (kWh)",       uk: "Очікувана виробка СЕС у розриві (кВт·год)","zh-cn": "缺口期间预计光伏发电量 (kWh)" },
	recommendation:           { en: "Charging Recommendation",                      de: "Ladeempfehlung",                                  ru: "Рекомендация по зарядке",                 pt: "Recomendação de carregamento",              nl: "Laadaanbeveling",                   fr: "Recommandation de charge",            it: "Raccomandazione di ricarica",           es: "Recomendación de carga",                pl: "Zalecenie ładowania",                      uk: "Рекомендація щодо зарядки",              "zh-cn": "充电建议" },
	lastCalculation:          { en: "Last Calculation",                              de: "Letzte Berechnung",                               ru: "Последний расчёт",                        pt: "Último cálculo",                            nl: "Laatste berekening",                fr: "Dernier calcul",                      it: "Ultimo calcolo",                        es: "Último cálculo",                        pl: "Ostatnie obliczenie",                      uk: "Останній розрахунок",                    "zh-cn": "最后计算时间" },
	chargingStartTime:        { en: "Planned Charging Start Time",                  de: "Geplanter Ladestart",                             ru: "Запланированное время начала зарядки",    pt: "Hora de início de carregamento planejada",  nl: "Geplande laadstarttijd",            fr: "Heure de début de charge prévue",     it: "Ora di inizio ricarica pianificata",    es: "Hora de inicio de carga planificada",   pl: "Planowany czas rozpoczęcia ładowania",     uk: "Запланований час початку зарядки",       "zh-cn": "计划充电开始时间" },
	chargingDurationMin:      { en: "Required Charging Duration (min)",              de: "Erforderliche Ladedauer (min)",                   ru: "Необходимая продолжительность зарядки (мин)",pt: "Duração de carregamento necessária (min)", nl: "Vereiste laadduur (min)",           fr: "Durée de charge requise (min)",       it: "Durata di ricarica richiesta (min)",    es: "Duración de carga requerida (min)",     pl: "Wymagany czas ładowania (min)",            uk: "Необхідна тривалість зарядки (хв)",      "zh-cn": "所需充电时长 (分钟)" },
	projectedSoc:             { en: "Projected Battery SoC at Phase Start (%)",     de: "Voraussichtlicher Akku-SoC bei Phasenbeginn (%)",ru: "Прогнозируемый SoC в начале фазы (%)",    pt: "SoC da bateria projetado no início da fase (%)",nl: "Verwachte batterij-SoC bij fasestart (%)",fr: "SoC batterie prévu au début de la phase (%)",it: "SoC batteria previsto all'inizio della fase (%)",es: "SoC de la batería proyectado al inicio de la fase (%)",pl: "Prognozowany SoC baterii na początku fazy (%)",uk: "Прогнозований SoC батареї на початку фази (%)",  "zh-cn": "阶段开始时预计电池SoC (%)" },
	gridChargingActive:       { en: "Grid Charging Active",                          de: "Netzladung aktiv",                                ru: "Сетевая зарядка активна",                 pt: "Carga da rede ativa",                       nl: "Netwerk laden actief",              fr: "Charge réseau active",                it: "Ricarica da rete attiva",               es: "Carga de red activa",                   pl: "Ładowanie z sieci aktywne",                uk: "Мережева зарядка активна",               "zh-cn": "电网充电激活" },
	batterySoc:               { en: "Current Battery SoC (%)",                      de: "Aktueller Akku-SoC (%)",                          ru: "Текущий SoC батареи (%)",                 pt: "SoC atual da bateria (%)",                  nl: "Huidige batterij-SoC (%)",          fr: "SoC actuel de la batterie (%)",       it: "SoC attuale della batteria (%)",        es: "SoC actual de la batería (%)",          pl: "Aktualny SoC baterii (%)",                 uk: "Поточний SoC батареї (%)",               "zh-cn": "当前电池SoC (%)" },
	triggerCalc:              { en: "Trigger Calculation Now",                       de: "Berechnung jetzt auslösen",                       ru: "Запустить расчёт сейчас",                 pt: "Acionar cálculo agora",                     nl: "Berekening nu activeren",           fr: "Déclencher le calcul maintenant",     it: "Avvia calcolo ora",                     es: "Activar cálculo ahora",                 pl: "Wyzwól obliczenie teraz",                  uk: "Запустити розрахунок зараз",             "zh-cn": "立即触发计算" },
};
...
class SmartChargingPlanner {
	...
	async _createStates() {
		await this._adapter.setObjectNotExistsAsync('smartCharging', {
			type: 'channel',
			common: { name: N.scChannel },
			native: {}
		});

		const stateDefinitions = {
			'targetSoc':            { name: N.targetSoc,           type: 'number',  role: 'value',                  unit: '%',   def: 0     },
			'cheapPhaseEnd':        { name: N.cheapPhaseEnd,   type: 'string',  role: 'value.datetime',         unit: null,  def: ''    },
			'solarSufficiencyTime': { name: N.solarSufficiencyTime, type: 'string',  role: 'value.datetime',         unit: null,  def: ''    },
			'energyGapKwh':         { name: N.energyGapKwh,       type: 'number',  role: 'value.power.consumption',unit: 'kWh', def: 0     },
			'estimatedPvKwh':       { name: N.estimatedPvKwh,    type: 'number',  role: 'value.power.consumption',unit: 'kWh', def: 0     },
			'recommendation':       { name: N.recommendation,                   type: 'string',  role: 'text',                   unit: null,  def: ''    },
			'lastCalculation':      { name: N.lastCalculation,                 type: 'string',  role: 'value.datetime',         unit: null,  def: ''    },
			'chargingStartTime':          { name: N.chargingStartTime,             type: 'string',  role: 'value.datetime',         unit: null,  def: ''    },
			'chargingDurationMin':        { name: N.chargingDurationMin,        type: 'number',  role: 'value',                  unit: 'min', def: 0     },
			'projectedSocAtPhaseStart':   { name: N.projectedSoc,type: 'number', role: 'value.battery',          unit: '%',   def: 0     },
			'gridChargingActive':         { name: N.gridChargingActive,            type: 'boolean', role: 'indicator',              unit: null,  def: false },
			'batterySoc':                 { name: N.batterySoc,                 type: 'number',  role: 'value.battery',          unit: '%',   def: 0     }
		};
	...
	async calculate() {
		try {
			...
			// Step 8: Estimate charging start time based on projected SoC
			const currentSoc = await this._getBatterySoc();
			const currentSocVal = currentSoc !== null ? currentSoc : 0;
			const nowHour = new Date().getHours() + new Date().getMinutes() / 60;
			// Project to cheap phase start (for display in Telegram/state)
			...
			// Project all the way to cheap phase END without any grid charging:
			// the battery discharges from now until phase end (including the time before charging starts),
			// so the deficit must cover that full drain to land at targetSoc when the phase ends.
			const projectedSocAtPhaseEnd = this._projectSocToPhaseStart(currentSocVal, nowHour, cheapPhase.endHour, consumptionAnalysis);
			const socDeficit = Math.max(0, targetSoc - projectedSocAtPhaseEnd);
	...
	_projectSocToPhaseStart(currentSoc, nowHour, phaseStartHour, consumptionAnalysis) {
		...
		this._adapter.log.debug(
			`SmartChargingPlanner: SoC projection: from=${currentSoc}% | drain=${consumedKwh.toFixed(2)} kWh (${socDrop.toFixed(1)}%) | projected=${projected.toFixed(1)}%`
		);
		return projected;
	}
