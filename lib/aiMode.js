...
${this._consumptionAnalyzer ? this._consumptionAnalyzer.formatForPrompt(context.consumptionAnalysis) : this._formatConsumptionAnalysis(context.consumptionAnalysis)}
`
			: '';
